...
export class UpdateTables1718565258712 implements MigrationInterface {
    name = 'UpdateTables1718565258712'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pedido_producto" ("id" SERIAL NOT NULL, "pedidoid" integer NOT NULL, "productoId" integer NOT NULL, "cantidad" integer NOT NULL, "pedidoId" integer, CONSTRAINT "PK_97f69aaf286bdd82afbd487e4d5" PRIMARY KEY ("id"))`);
